...
class PascalVocGenerator(Generator):
    def __init__(
        ...
        classes=voc_classes,
        image_extension='.jpg', # cambia formato image 
		#image_extension='',
    ...
    def image_aspect_ratio(self, image_index):
        path  = os.path.join(self.data_dir, 'new_dataset', self.image_names[image_index] + self.image_extension)   #  JPEGImages == new_dataset
        image = Image.open(path)
        return float(image.width) / float(image.height)

    def load_image(self, image_index):
        path = os.path.join(self.data_dir, 'new_dataset', self.image_names[image_index] + self.image_extension)
    ...
    def load_annotations(self, image_index):
        ...
        try:
            tree = ET.parse(os.path.join(self.data_dir, 'annotations', filename))  ## Annotations
